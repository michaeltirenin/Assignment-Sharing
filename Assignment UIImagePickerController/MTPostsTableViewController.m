...
- (void)viewDidLoad
{
    ...
    post1.picture = [UIImage imageNamed:@"dougherty1.jpg"];
    ...
    post2.picture = [UIImage imageNamed:@"dougherty2.jpg"];
    ...
    post3.picture = [UIImage imageNamed:@"dougherty3.jpg"];
    ...
    post4.picture = [UIImage imageNamed:@"dougherty4.jpg"];
    ...
    post5.picture = [UIImage imageNamed:@"dougherty5.jpg"];
    ...
    post6.picture = [UIImage imageNamed:@"dougherty6.jpg"];
    ...
    post7.picture = [UIImage imageNamed:@"dougherty7.jpg"];
    ...
    post8.picture = [UIImage imageNamed:@"dougherty8.jpg"];
    ...
    post9.picture = [UIImage imageNamed:@"dougherty9.jpg"];
    ...
    post10.picture = [UIImage imageNamed:@"dougherty10.jpg"];
